 ...
 * @return bool
 */
public function addBdl($id_composante, $id_prestataire, $annee = 2024, $mois = 05, $signature_interlocuteur = false, $signature_prestataire = null, $commentaire = "", $heures = 0,$id_interlocuteur,$id_gestionnaire) {
    try {
