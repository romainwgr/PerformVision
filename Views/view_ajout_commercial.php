...
?>
    <div class="add-container">
        <div class="form-abs">
            ...
            <form
                action="?controller=<?php $_GET['controller'] ?>>&action=<?php if(isset($_GET['id'])): echo 'ajout_commercial_dans_composante&id-composante=' . $_GET['id']; else: echo 'ajout_commercial'; endif;?>"
                method="post">
