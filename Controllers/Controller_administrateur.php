...
class Controller_administrateur extends Controller
{
    ...
    public function action_ajout_interlocuteur_form()
    {
        ...
        $ajoutInterlocuteurLink = '?controller=administrateur&action=ajout_interlocuteur_dans_composante'; //le lien que tu dois modifier pour qu'il renvoie à l'action du commercial adéquate
